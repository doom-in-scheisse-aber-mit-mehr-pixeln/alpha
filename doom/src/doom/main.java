...
public class main
{
	public static void main(String[] args) throws IOException
	{
		...
		serverSide networkListener=new serverSide(5000);
		networkListener.start();
		
		//clientSide networkTalker=new clientSide("192.168.0.34", 5000);
		//networkTalker.start();
		...
		while(true)
		{
			...
			monkeyTransform=networkListener.getPlayerTransform();
