...
public class Display extends Canvas{
	...
	private BufferedImage[] weapons=new BufferedImage[4];
	...
	public void loadWeapons() {
		...
		try {weapons[1] = ImageIO.read(new File("./res/weapons/M4A4.png"));} catch (IOException e) {}
		try {weapons[2] = ImageIO.read(new File("./res/weapons/T_Knife.png"));} catch (IOException e) {}
		try {weapons[3] = ImageIO.read(new File("./res/weapons/CT_Knife.png"));} catch (IOException e) {}
	}
	public void setWeapon(int weaponNumber) {weapon=weapons[weaponNumber];}
